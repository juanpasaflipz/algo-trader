...
async def analyze(
    analysis_type: AnalysisType, request_data: Dict[str, Any]
...
async def _analyze_trade(
    ai_service, request: TradeAnalysisRequest
) -> TradeAnalysisResponse:
...
async def _analyze_backtest(
    ai_service, request: BacktestAnalysisRequest
) -> BacktestAnalysisResponse:
    ...
    analysis = await ai_service.analyze_backtest_results(
        backtest_result, include_trade_analysis=request.include_trade_analysis
    )
...
async def _analyze_market(
    ai_service, request: MarketCommentaryRequest
) -> MarketCommentaryResponse:
...
async def _analyze_risk(
    ai_service, request: RiskAssessmentRequest
) -> RiskAssessmentResponse:
    ...
    potential_profit = (
        abs(request.take_profit - request.entry_price) * request.position_size
    )
...
async def _analyze_strategy(
    ai_service, request: StrategyOptimizationRequest
) -> StrategyOptimizationResponse:
